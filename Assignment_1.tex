...
%           &= \frac{\pr{E|X=0}\pr{X=0}}{\pr{E}} \\
%           &= \frac{\pr{E|X=0}\pr{X=0}}{\pr{E|X=0}\pr{X=0}+\pr{E|X=1}\pr{X=1}}
%  \label{eq:Bayes} 
%\end{align}
...
\begin{align}
    \pr{X=0|E} &= \frac{\pr{E,X=0}}{\pr{E}} \\
           &= \frac{\pr{E|X=0}\pr{X=0}}{\pr{E}} \\
           &= \frac{\pr{E|X=0}\pr{X=0}}{\sum_{i=0}^1 \pr{E|X=i}\pr{X=i}}
  \label{eq:Bayes} 
\end{align}

Substituing eqs.\eqref{eq:PX} and\eqref{eq:PEgivenX} in\eqref{eq:Bayes},\\
